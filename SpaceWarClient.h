...
{
	enum EFriendsMenuItemCommand
	{
		k_EFriendsListMenuItem,
		k_EFriendsListMenuItemSendMessage,
		k_EFriendsListMenuItemViewProfile,
		k_EFriendsListMenuItemAcceptFriendRequest,
		k_EFriendsListMenuItemIgnoreFriendRequest,
		k_EFriendsListMenuItemRemoveFriend,
		k_EFriendsListMenuItemBack
	};

	CSteamID m_steamIDFriend;
	EFriendsMenuItemCommand m_eCommand;
	EFriendRelationship m_eSteamFriendRelationship; // the relationship of the friend in the friends list
	FriendGameInfo_t m_steamFriendGameInfo;	// In-game friend game information 
	bool m_bIsFriendOnline = false;
